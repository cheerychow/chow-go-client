...
// WithRecipeID adds the recipeID to the delete recipe params
func (o *DeleteRecipeParams) WithRecipeID(recipeID string) *DeleteRecipeParams {
	o.SetRecipeID(recipeID)
	return o
}

// SetRecipeID adds the recipeId to the delete recipe params
func (o *DeleteRecipeParams) SetRecipeID(recipeID string) {
	o.RecipeID = recipeID
}
